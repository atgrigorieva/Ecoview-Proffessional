...
{
    class DecriptorPribor
    {
        string filename, pathname;
        public DecriptorPribor(ref string filename1, string pathname1)
        {
            this.filename = filename1;
            this.pathname = pathname1;

            PriborDecriptor(ref filename);
            filename1 = this.filename;

        }
        public void PriborDecriptor(ref string filename)
        {
