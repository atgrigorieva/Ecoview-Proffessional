...
namespace Ecoview_Professional
{
    public partial class MultiWave : Form
    {
        ...
        public MultiWave(CreateDimension parent, string versionPribor1)
        {
            InitializeComponent();
            this._Analis = parent;
        ...
        private void txt_Leave(object sender, EventArgs e)
        {
            ...
            if (_Analis.textBoxCO[active].Text != "")
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            _Analis.CountSeriya = comboBox1.SelectedItem.ToString();
            _Analis.Datagriview5Create();
            Close();
        }
